...
class USER(threading.Thread):
    ...
    def __init__(self, host, port, CID, password, merchant_pub_key):
    ...
    def request_authentication(self):
        ...
        x = pickle.dumps(data)
        self.sm.send_message(BANK_HOST, BANK_PORT, x)
    ...
    def deligate(self, amount_allowed, merchant_pub_key,
        ...
        x = pickle.dumps(data)
        self.sm.send_message(BC_HOST, BC_PORT, x)
        # s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
...
user = USER(CUSTOMER_HOST, CUSTOMER_PORT, 1, '1234', None)